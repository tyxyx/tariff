...
export default function CalculatorPage() {
  ...
  useEffect(() => {
    ...
    if (activeTab === "Calculator" && originCountry && product && calculationDate) {
      const originParam = encodeURIComponent(originCountry);
      const productParam = encodeURIComponent(product);
      fetch(`http://${process.env.NEXT_PUBLIC_BACKEND_EC2_HOST}:8080/api/tariffs/valid-destinations?originCountry=${originParam}&productName=${productParam}`)
        .then(async (res) => {
          if (!res.ok) {
        ...
        .then(data => {
          if (Array.isArray(data) && data.length === 0) {
            setTariffError("No valid tariff data for selected import country and product.");
  ...
  const summarySpecificRate = activeTab === "Calculator" ? specificRate : simSpecificRate;
  const summaryAdValoremRate = activeTab === "Calculator" ? adValoremRate : simAdValoremRate;
  // Render summary using these values
  const summaryAmountSpecific = summarySpecificRate * quantity;
  const summaryAmountAdValorem = (summaryAdValoremRate / 100) * (unitPrice * quantity);
      ...
      <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row gap-8">
        ...
        <Card className="max-w-lg w-full mx-auto">
          ...
          <div className="flex border-b border-gray-700 mb-6">
            <button
              className={`px-4 py-2 text-white font-medium border-b-2 ${activeTab === "Calculator" ? "border-blue-500" : "border-transparent"
                }`}
            ...
            <button
              className={`px-4 py-2 text-white font-medium border-b-2 ${activeTab === "Simulation" ? "border-blue-500" : "border-transparent"
                }`}
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    {countries
                      .filter(country => country.name !== "World" && country.name !== "Unspecified")
                ...
                <div>
                  ...
                  <input
                    ...
                    min={0}
                    step="any"
                    value={activeTab === "Calculator" ? specificRate : simSpecificRate}
                    onChange={e =>
                      activeTab === "Calculator"
                ...
                <div>
                  ...
                  <input
                    ...
                    min={0}
                    step="any"
                    value={activeTab === "Calculator" ? adValoremRate : simAdValoremRate}
                    onChange={e =>
                      activeTab === "Calculator"
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="0"
                    value={
                      !specificRateFocused && (simSpecificRate === "" || simSpecificRate === "0")
                    ...
                    onChange={e => setSimSpecificRate(e.target.value.replace(/^0+/, ""))}
                    className="w-full border rounded px-3 py-2"
                    style={{ backgroundColor: "black", color: "white" }}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="0"
                    value={
                      !adValoremRateFocused && (simAdValoremRate === "" || simAdValoremRate === "0")
                        ? ""
                    ...
                    onChange={e => setSimAdValoremRate(e.target.value.replace(/^0+/, ""))}
                    className="w-full border rounded px-3 py-2"
                    style={{ backgroundColor: "black", color: "white" }}
                  />
                </div>
        ...
        <Card className="max-w-md w-full mx-auto">
          ...
          <CardContent>
            <ul className="space-y-2">
              ...
              <li>
                <strong>Import Country:</strong> {findCountryName(originCountry) || "-"}
              </li>
              <li>
                <strong>Export Country:</strong> {findCountryName(destCountry) || "-"}
              </li>
              <li>
              ...
              <li><strong>Specific Rate:</strong> {summarySpecificRate}</li>
              <li><strong>Ad Valorem Rate (%):</strong> {summaryAdValoremRate}</li>
              <li><strong>Specific Duty Amount:</strong> {summaryAmountSpecific.toLocaleString()}</li>
              <li><strong>Ad Valorem Duty Amount:</strong> {summaryAmountAdValorem.toLocaleString()}</li>
